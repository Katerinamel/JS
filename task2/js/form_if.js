...
function addForm() {
    ...
    if ((yourGender == "woman") && (typeAge.value < retirementAgeWoman)) {
        retirement.innerHTML = "no";
    } else if ((yourGender == "woman") && (typeAge.value >= retirementAgeWoman)) {
        retirement.innerHTML = "yes";
    }
    else if ((yourGender == "man") && (typeAge.value < retirementAgeMan)) {
        retirement.innerHTML = "no";
    } else  {
        retirement.innerHTML = "yes";
    };
